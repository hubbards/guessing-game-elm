...
findMax tree =
    case tree of
        ...
        Node x l r ->
            helper max x (findMax l) (findMax r)
...
findMin tree =
    case tree of
        ...
        Node x l r ->
            helper min x (findMin l) (findMin r)
    ...
    case tree of
        ...
        Node x l r ->
            let
                ...
                p =
                    f <| Maybe.map ((>=) x) (findMax l)

                q =
                    f <| Maybe.map ((<=) x) (findMax r)
            in
            isBst l && isBst r && p && q
